...
<link rel="stylesheet" type="text/css" href="<?php echo SERVERURL; ?>views/style/content.css">
...
<link rel="shortcut icon" href="<?php echo SERVERURL; ?>views/resource/icon.ico" type="image/x-icon">