<main>  
    <div class="presentacion" style="background-image: url(<?php echo SERVERURL; ?>views/resource/code/Code.jpg">
        <div>Code :</div>
    ...
    <div class="content">
        <div class="one">
            ...
            <img src="<?php echo SERVERURL; ?>views/resource/code/estados.png" alt="Estados del juego">
        </div>
        <div class="two">
            ...
            <img src="<?php echo SERVERURL; ?>views/resource/code/Movimiento_player.png" alt="Movimiento del jugador">
        </div>
        <div class="three">
            ...
            <img src="<?php echo SERVERURL; ?>views/resource/code/enemigo.png" alt="Movimiento de los Enemigos">
        </div>
    </div>  
</main>